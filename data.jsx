...
const EVENTS = [
  ...
  e("ansiaes","Feira Medieval de Ansiães","","Medieval","2026-05-30","2026-05-31","Carrazeda de Ansiães","Norte",41.242,-7.305, IMG+"Feira-Medieval-de-Ansiaes-30-de-Maio-de-2026-Carrazeda-de-Ansiaes-400x250.jpg"),
  ...
  e("lobelhe","Feira Medieval de Lobelhe do Mato","","Medieval","2026-06-05","2026-06-07","Lobelhe do Mato, Mangualde","Centro",40.55,-7.78),
  e("trofeu-obidos","Grande Troféu Ibérico · Óbidos 2026","","Torneio","2026-06-05","2026-06-07","Óbidos","Centro",39.36,-9.157),
  e("pinhel","Feira Medieval de Pinhel","A Cidade do Falcão","Medieval","2026-06-05","2026-06-07","Pinhel, Guarda","Centro",40.77,-7.06),
  e("vfxira","Mercado Medieval de Vila Franca de Xira","","Mercado","2026-06-05","2026-06-07","Vila Franca de Xira","Lisboa",38.955,-8.99),
  e("torrao","Torrão Quinhentista","Alcácer do Sal","Quinhentista","2026-06-05","2026-06-07","Torrão, Alcácer do Sal","Alentejo",38.29,-8.21),
  e("machico","Mercado Quinhentista de Machico","","Quinhentista","2026-06-05","2026-06-07","Machico, Madeira","Ilhas",32.71,-16.77),
  e("esgueira","Festas Quinhentistas da Esgueira","","Quinhentista","2026-06-05","2026-06-07","Esgueira, Aveiro","Centro",40.65,-8.62),
  e("aguiar","Crónicas de Aguiar","Aguiar da Beira","Medieval","2026-06-05","2026-06-07","Aguiar da Beira","Centro",40.81,-7.54),
  e("lobrigos","Feira Medieval de São João de Lobrigos","","Medieval","2026-06-05","2026-06-07","Santa Marta de Penaguião","Norte",41.18,-7.78),
  e("seide","Feira Medieval de Seide","","Medieval","2026-06-06","2026-06-06","Seide, Vila Nova de Famalicão","Norte",41.40,-8.52),
  ...
  e("montemornovo","Feira Medieval Castelo de Montemor-o-Novo","","Medieval","2026-06-12","2026-06-14","Montemor-o-Novo","Alentejo",38.648,-8.21),
  e("moalde","Moalde Medieval de São Mamede Infesta","","Medieval","2026-06-12","2026-06-14","São Mamede Infesta, Matosinhos","Norte",41.20,-8.61),
  ...
  e("carvalhal","Feira Medieval do Carvalhal","","Medieval","2026-06-12","2026-06-14","Carvalhal, Bombarral","Centro",39.27,-9.18),
  ...
  e("trancoso","Feira Medieval de Trancoso","","Medieval","2026-06-26","2026-06-28","Trancoso","Centro",40.78,-7.35),
  e("beato","Feira Medieval do Beato","","Medieval","2026-06-26","2026-06-28","Beato, Lisboa","Lisboa",38.73,-9.10),
  ...
  // ---- Julho ----
  e("elvas","Festival Medieval de Elvas","","Medieval","2026-07-02","2026-07-05","Elvas","Alentejo",38.88,-7.16),
  ...
  e("penedono","Feira Medieval de Penedono","","Medieval","2026-07-03","2026-07-05","Penedono","Centro",40.99,-7.40),
  e("cambra","Mercado Medieval de Cambra","","Mercado","2026-07-03","2026-07-05","Cambra, Vouzela","Centro",40.72,-8.16),
  e("serradelrei","Feira Medieval de Serra D'el Rei","","Medieval","2026-07-03","2026-07-05","Serra D'el Rei, Peniche","Centro",39.32,-9.30),
  e("azambuja","Mercado Medieval de Azambuja","","Mercado","2026-07-04","2026-07-04","Azambuja","Lisboa",39.07,-8.87),
  e("ribeiragrande","Feira Quinhentista da Ribeira Grande","","Quinhentista","2026-07-09","2026-07-12","Ribeira Grande, Açores","Ilhas",37.82,-25.51),
  e("sintra","Feira Medieval de Sintra","","Medieval","2026-07-09","2026-07-12","Praça D. Fernando II, Sintra","Lisboa",38.80,-9.39),
  ...
  e("valdevez","O Recontro de Valdevez","","Histórica","2026-07-10","2026-07-12","Paço da Giela, Arcos de Valdevez","Norte",41.85,-8.42),
  e("moes","Feira Medieval de Mões","","Medieval","2026-07-10","2026-07-12","Mões, Castro Daire","Centro",40.93,-7.85),
  e("mindelo","Feira Medieval do Mindelo","XIII Edição","Medieval","2026-07-10","2026-07-12","Mindelo, Vila do Conde","Norte",41.31,-8.73),
  e("pirata-leca","Festival Pirata de Leça da Palmeira","","Histórica","2026-07-10","2026-07-13","Forte das Neves, Leça da Palmeira","Norte",41.20,-8.71),
  ...
  e("avenidasnovas","Feira Medieval das Avenidas Novas","","Medieval","2026-07-14","2026-07-17","Avenidas Novas, Lisboa","Lisboa",38.74,-9.15),
  e("obidos","Mercado Medieval de Óbidos","","Mercado","2026-07-16","2026-07-26","Óbidos","Centro",39.36,-9.157),
  e("galaicofolia","Galaicofolia","Castro de S. Lourenço","Histórica","2026-07-16","2026-07-19","Vila Chã, Esposende","Norte",41.55,-8.77),
  e("canelas","Jornadas Medievais de Canelas do Douro","","Medieval","2026-07-17","2026-07-19","Canelas, Peso da Régua","Norte",41.16,-7.78),
  e("oitocentista-vimeiro","Feira Oitocentista do Vimeiro","","Histórica","2026-07-17","2026-07-19","Vimeiro, Lourinhã","Lisboa",39.18,-9.30),
  e("salir","Salir do Tempo","Época Romana","Romana","2026-07-17","2026-07-19","Salir, Loulé","Algarve",37.25,-8.05),
  e("batalha-vimeiro","Recriação da Batalha do Vimeiro 1808","","Histórica","2026-07-17","2026-07-19","Vimeiro, Lourinhã","Lisboa",39.18,-9.30),
  e("leiria","Leiria Medieval","","Medieval","2026-07-17","2026-07-19","Praça da República, Leiria","Centro",39.745,-8.807),
  e("constantim","Feira Medieval de Constantim","","Medieval","2026-07-18","2026-07-19","Constantim, Vila Real","Norte",41.35,-7.69),
  e("canha","Feira Medieval de Canha","","Medieval","2026-07-24","2026-07-26","Canha, Montijo","Lisboa",38.77,-8.62),
  e("anadia","Mercado Medieval de Anadia","","Mercado","2026-07-24","2026-07-26","Vilarinho do Bairro, Anadia","Centro",40.44,-8.50),
  ...
  e("aljubarrota","Aljubarrota Medieval","","Medieval","2026-08-13","2026-08-16","Aljubarrota, Alcobaça","Centro",39.55,-8.93),
  ...
  e("montinho","Mercado Medieval de Montinho","","Mercado","2026-08-21","2026-08-23","Pocariça, Cantanhede","Centro",40.34,-8.59),
  e("castromarim","Dias Medievais de Castro Marim","","Medieval","2026-08-26","2026-08-30","Castro Marim","Algarve",37.22,-7.44),
  e("almeida","Recriação do Cerco de Almeida","","Histórica","2026-08-28","2026-08-30","Almeida","Centro",40.726,-6.906),
  ...
  e("cordiana","Mercado Medieval de Villa Cordiana","","Mercado","2026-09-04","2026-09-06","Cordinhã, Cantanhede","Centro",40.32,-8.55),
  e("ceyceyra","Ceyceyra Medieval","","Medieval","2026-09-18","2026-09-20","Asseiceira, Tomar","Centro",39.54,-8.46),
  e("alvalade","Alvalade Medieval","","Medieval","2026-09-18","2026-09-20","Alvalade do Sado, Santiago do Cacém","Alentejo",37.95,-8.39),
  e("marvila","Feira Medieval de Marvila","","Medieval","2026-09-25","2026-09-27","Vale Fundão, Marvila","Lisboa",38.74,-9.10),
  e("palmela","Feira Medieval de Palmela","","Medieval","2026-09-25","2026-09-27","Castelo de Palmela","Lisboa",38.57,-8.90),

  // ---- Outubro ----
  e("canas","Feira Medieval de Canas de Senhorim","","Medieval","2026-10-02","2026-10-04","Canas de Senhorim, Nelas","Centro",40.50,-7.90),
  e("azurara","Mercado Medieval de Azurara","","Mercado","2026-10-02","2026-10-05","Azurara, Vila do Conde","Norte",41.34,-8.74),
  ...
  e("dias-templarios","Dias Templários de Tomar","","Templária","2026-10-10","2026-10-11","Tomar","Centro",39.604,-8.41),
  ...
  e("congresso","V Congresso dos Arqueólogos Portugueses","","Histórica","2026-11-18","2026-11-21","Lisboa","Lisboa",38.71,-9.14),
];
